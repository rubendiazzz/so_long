...
#    Updated: 2024/03/04 15:06:27 by ruubendiazz      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			=	ft_isalnum.c ft_isprint.c ft_memcmp.c  ft_putchar_fd.c ft_split.c \
					...
					ft_putstr_fd.c ft_strjoin.c ft_strmapi.c ft_strtrim.c ft_format.c \
					ft_printf.c ft_printf.h get_next_line.c get_next_line.h \
